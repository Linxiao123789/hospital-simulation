...
repo_desk_size = [6,8,10,12,14,16]
phar_desk_size = [20,22,24,26,28]
sim_num = 1
for i in range(sim_num):
    for j in range(len(phar_desk_size)):
        ...
        result = Hospitalsim(copy.deepcopy(model), self_desk_size= self_desk_size[0],
                             ...
                             repo_desk_size=repo_desk_size[0], phar_desk_size=phar_desk_size[j])
...
for obj in simlist:
    ...
    Ws_phar_d.append(t_phar / count_phar)
    ...
    Ls_phar_d.append(t_phar / running_time)
...
for obj in simlist:
    ...
    Wq_phar_d.append(t_phar / count_phar)
    ...
    Lq_phar_d.append(t_phar / running_time)
...
print('---------')
print("------Ws")
for i in range(len(Ws_phar_d)):
    print('      Ws_phar= ', Ws_phar_d[i])

print("------Wq")

for i in range(len(Ws_phar_d)):
    print('      Wq_phar= ', Wq_phar_d[i])

print("------Ls")

for i in range(len(Ws_phar_d)):
    print('      Ls_phar= ', Ls_phar_d[i])

print("------Lq")

for i in range(len(Ws_phar_d)):
    print('      Lq_phar= ', Lq_phar_d[i])



#diagrams
##################
scope = phar_desk_size
...
plt.title('Ws')
plt.xlabel(' Pharmacy Size')
plt.ylabel('Value')
plt.plot(scope,Ws_phar_d,'r', linewidth=1)
...
plt.xlabel(' Pharmacy Size')
plt.ylabel('Value')
plt.plot(scope,Wq_phar_d,'r', linewidth=1)
...
plt.xlabel(' Pharmacy Size')
plt.ylabel('Value')
plt.plot(scope,Ls_phar_d,'r', linewidth=1)
...
plt.xlabel(' Pharmacy Size')
plt.ylabel('Value')
plt.plot(scope,Lq_phar_d,'r', linewidth=1)

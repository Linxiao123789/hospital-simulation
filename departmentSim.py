...
ultr_desk_size = [14,15,16]
bloo_desk_size = [12,13,14]
endo_desk_size = [10,11,12]
...
for i in range(sim_num):
    for j in range(len(inte_desk_size)):
        ...
        result = Hospitalsim(copy.deepcopy(model), self_desk_size= self_desk_size[0],
                             inte_desk_size=inte_desk_size[j], surg_desk_size=surg_desk_size[j], eyes_desk_size=eyes_desk_size[j], ENT_desk_size=ENT_desk_size[j], orth_desk_size=orth_desk_size[j],
                             ultr_desk_size=ultr_desk_size[1], bloo_desk_size=bloo_desk_size[1], endo_desk_size=endo_desk_size[1],
...
for obj in simlist:
    ...
    Ws_inte_d.append(t_inte / count_inte)
    Ws_surg_d.append(t_surg / count_surg)
    Ws_eyes_d.append(t_eyes / count_eyes)
    Ws_ENT_d.append(t_ENT / count_ENT)
    Ws_orth_d.append(t_orth / count_orth)
    ...
    Ls_inte_d.append(t_inte / running_time)
    Ls_surg_d.append(t_surg / running_time)
    Ls_eyes_d.append(t_eyes / running_time)
    Ls_ENT_d.append(t_ENT / running_time)
    Ls_orth_d.append(t_orth / running_time)
...
for obj in simlist:
    ...
    Wq_inte_d.append(t_inte / count_inte)
    Wq_surg_d.append(t_surg / count_surg)
    Wq_eyes_d.append(t_eyes / count_eyes)
    Wq_ENT_d.append(t_ENT / count_ENT)
    Wq_orth_d.append(t_orth / count_orth)
    ...
    Lq_inte_d.append(t_inte / running_time)
    Lq_surg_d.append(t_surg / running_time)
    Lq_eyes_d.append(t_eyes / running_time)
    Lq_ENT_d.append(t_ENT / running_time)
    Lq_orth_d.append(t_orth / running_time)
...
print('---------')
print("------Ws")
for i in range(len(Ws_surg_d)):
    print('      Ws_inte= ', Ws_inte_d[i])
    print('      Ws_surg= ', Ws_surg_d[i])
    print('      Ws_eyes= ', Ws_eyes_d[i])
    print('      Ws_ENT= ', Ws_ENT_d[i])
    print('      Ws_orth= ', Ws_orth_d[i])
print("------Wq")
for i in range(len(Ws_surg_d)):
    print('      Wq_inte= ', Wq_inte_d[i])
    print('      Wq_surg= ', Wq_surg_d[i])
    print('      Wq_eyes= ', Wq_eyes_d[i])
    print('      Wq_ENT= ', Wq_ENT_d[i])
    print('      Wq_orth= ', Wq_orth_d[i])
print("------Ls")
for i in range(len(Ws_surg_d)):
    print('      Ls_inte= ', Ls_inte_d[i])
    print('      Ls_surg= ', Ls_surg_d[i])
    print('      Ls_eyes= ', Ls_eyes_d[i])
    print('      Ls_ENT= ', Ls_ENT_d[i])
    print('      Ls_orth= ', Ls_orth_d[i])
print("------Lq")
for i in range(len(Ws_surg_d)):
    print('      Lq_inte= ', Lq_inte_d[i])
    print('      Lq_surg= ', Lq_surg_d[i])
    print('      Lq_eyes= ', Lq_eyes_d[i])
    print('      Lq_ENT= ', Lq_ENT_d[i])
    print('      Lq_orth= ', Lq_orth_d[i])


#diagrams
##################
scope = inte_desk_size
scope1 = surg_desk_size
scope2 = eyes_desk_size
scope3 = ENT_desk_size
scope4 = orth_desk_size
##################
plt.subplot(221)
ax1=plt.gca()
...
plt.ylabel('Value')
plt.plot(scope,Ws_inte_d,'r', linewidth=1)
plt.plot(scope1,Ws_surg_d,'r', linewidth=1,c='g')
plt.plot(scope2,Ws_eyes_d,'r', linewidth=1,c='b')
plt.plot(scope3,Ws_ENT_d,'r', linewidth=1,c='y')
plt.plot(scope4,Ws_orth_d,'r', linewidth=1,c='#000000')
####
plt.subplot(222)
ax2=plt.gca()
...
plt.xlabel('Department Size')
plt.ylabel('Value')
plt.plot(scope,Wq_inte_d,'r', linewidth=1)
plt.plot(scope1,Wq_surg_d,'r', linewidth=1,c='g')
plt.plot(scope2,Wq_eyes_d,'r', linewidth=1,c='b')
plt.plot(scope3,Wq_ENT_d,'r', linewidth=1,c='y')
plt.plot(scope4,Wq_orth_d,'r', linewidth=1,c='#000000')
...
plt.xlabel('Department Size')
plt.ylabel('Value')
plt.plot(scope,Ls_inte_d,'r', linewidth=1)
plt.plot(scope1,Ls_surg_d,'r', linewidth=1,c='g')
plt.plot(scope2,Ls_eyes_d,'r', linewidth=1,c='b')
plt.plot(scope3,Ls_ENT_d,'r', linewidth=1,c='y')
plt.plot(scope4,Ls_orth_d,'r', linewidth=1,c='#000000')
####
plt.subplot(222)
ax4=plt.gca()
...
plt.xlabel('Department Size')
plt.ylabel('Value')
plt.plot(scope,Lq_inte_d,'r', linewidth=1)
plt.plot(scope1,Lq_surg_d,'r', linewidth=1,c='g')
plt.plot(scope2,Lq_eyes_d,'r', linewidth=1,c='b')
plt.plot(scope3,Lq_ENT_d,'r', linewidth=1,c='y')
plt.plot(scope4,Lq_orth_d,'r', linewidth=1,c='#000000')
plt.show()
###################

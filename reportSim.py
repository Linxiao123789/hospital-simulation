...
repo_desk_size = [6,7,8,9,10]
phar_desk_size = [20,22,24,26,28]
sim_num = 1
for i in range(sim_num):
    for j in range(len(repo_desk_size)):
        ...
        result = Hospitalsim(copy.deepcopy(model), self_desk_size= self_desk_size[0],
                             ...
                             ultr_desk_size=ultr_desk_size[0], bloo_desk_size=bloo_desk_size[0], endo_desk_size=endo_desk_size[0],
                             repo_desk_size=repo_desk_size[j], phar_desk_size=phar_desk_size[1])
...
for obj in simlist:
    ...
    Ws_repo_d.append(t_repo / count_repo)
    ...
    Ls_repo_d.append(t_repo / running_time)
...
for obj in simlist:
    ...
    Wq_repo_d.append(t_repo / count_repo)
    ...
    Lq_repo_d.append(t_repo / running_time)
...
print('---------')
print("------Ws")
for i in range(len(Ws_repo_d)):
    print('      Ws_repo= ', Ws_repo_d[i])

print("------Wq")
print('Wq0= ',Wq0/sim_num)

for i in range(len(Ws_repo_d)):
    print('      Wq_repo= ', Wq_repo_d[i])

print("------Ls")

for i in range(len(Ws_repo_d)):
    print('      Ls_repo= ', Ls_repo_d[i])

print("------Lq")

for i in range(len(Ws_repo_d)):
    print('      Lq_repo= ', Lq_repo_d[i])



#diagrams
##################
scope = repo_desk_size
...
plt.title('Ws')
plt.xlabel(' Report Printer Size')
plt.ylabel('Value')
plt.plot(scope,Ws_repo_d,'r', linewidth=1)
...
plt.xlabel(' Report Printer Size')
plt.ylabel('Value')
plt.plot(scope,Wq_repo_d,'r', linewidth=1)
...
plt.xlabel(' Report Printer Size')
plt.ylabel('Value')
plt.plot(scope,Ls_repo_d,'r', linewidth=1)
...
plt.xlabel(' Report Printer Size')
plt.ylabel('Value')
plt.plot(scope,Lq_repo_d,'r', linewidth=1)
